...
namespace sm_coding_challenge
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //register DataStoreService and DataHostedService as singleton classes 
            services.AddSingleton<IDataStoreService, DataStoreService>();
            services.AddSingleton<IHostedService, DataHostedService>();

            //register the data hosted service
